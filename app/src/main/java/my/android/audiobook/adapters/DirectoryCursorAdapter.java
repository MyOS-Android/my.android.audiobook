...
public class DirectoryCursorAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        String path = cursor.getString(cursor.getColumnIndex(BookContract.DirectoryEntry.COLUMN_PATH));
        ...
        Directory.Type type = Directory.Type.valueOf(cursor.getInt(cursor.getColumnIndex(BookContract.DirectoryEntry.COLUMN_TYPE)));
