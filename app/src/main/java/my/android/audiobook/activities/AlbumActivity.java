...
import my.android.audiobook.adapters.AudioFileCursorAdapter;
...
public class AlbumActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>, PlayStatusChangeListener, SynchronizationStateListener {
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        ...
        String sel = BookContract.AudioEntry.TABLE_NAME + "." + BookContract.AudioEntry.COLUMN_ALBUM + "=?";
        ...
        return new CursorLoader(this, BookContract.AudioEntry.CONTENT_URI, projection, sel, selArgs, sortOrder);
    }
